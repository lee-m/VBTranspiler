...
constStmt : (publicPrivateGlobalVisibility WS)? CONST WS constSubStmt (WS? ',' WS? constSubStmt)*;
...
enumerationStmt: 
	(publicPrivateVisibility WS)? ENUM WS ambiguousIdentifier NEWLINE+ 
...
publicPrivateGlobalVisibility : publicPrivateVisibility | GLOBAL;
visibility : publicPrivateGlobalVisibility | FRIEND;
